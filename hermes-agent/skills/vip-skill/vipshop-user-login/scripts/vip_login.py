...
class VIPLoginManager:
    ...
    def login(
        ...
        # ComWorker 环境：尝试发送图片 + 打印链接
        if os.environ.get("COMWORKER_SESSION") == "1" and qr_file_path:
            print(f"\n[COMWORKER_SEND_FILE]{qr_file_path}[/COMWORKER_SEND_FILE]")
