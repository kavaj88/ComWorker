---
name: skill-scanner
description: "Scan any agent skill for security risks before you install or use it. Powered by Tencent Zhuque Lab A.I.G (AI-Infra-Guard). 100% local static analysis — no file contents or credentials leave your device. Compatible with CodeBuddy, Cursor, Windsurf, Claude Code, ComWorker and more. Triggers on: 这个 skill 安全吗, skill 安全扫描, 检查 skill 安全, audit skill, scan skill, check skill safety, analyze skill, inspect skill, verify skill, skill security, skill supply chain. Do NOT trigger for general agent usage, full system health checks, project debugging, or normal development."
...
Compatible with any agent platform that supports skills (e.g. ComWorker, Qclaw, WorkBuddy, CodeBuddy, Cursor, Windsurf, Claude Code, etc.).
...
limited to: **ComWorker, Cursor, Windsurf, CodeBuddy, WorkBuddy, Claude Code, qclaw**, etc.
...
|----------|-----------------|
| **ComWorker** | Ask the Agent: "你的 skill 有哪些" or "list your skills" to get the full skill list |
