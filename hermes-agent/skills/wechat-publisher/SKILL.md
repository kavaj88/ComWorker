...
基于 [wenyan-cli](https://github.com/caol64/wenyan-cli) 封装的 ComWorker skill。
...
API 凭证已保存在 `/Users/leebot/.comworker/workspace/TOOLS.md`
...
```bash
cd /Users/leebot/.comworker/workspace/wechat-publisher
