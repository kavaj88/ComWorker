#!/usr/bin/env python3
"""
Email Sender Skill for ComWorker
...
class EmailSender:
    ...
    def load_config(self, config_path: str = None) -> dict:
        ...
        env_config = {
            ...
            'sender_name': os.getenv('EMAIL_SENDER_NAME', 'ComWorker Assistant'),
    ...
    def send_email(
        ...
        try:
            ...
            msg['From'] = f"{self.config.get('sender_name', 'ComWorker')} <{self.config['username']}>"
    ...
    def send_test_email(self, to_email: str = None) -> dict:
        ...
        subject = "Test Email from ComWorker"
        body = """This is a test email sent from your ComWorker assistant.
