# ComWorker Email Skill 📧

A comprehensive email management and automation skill for ComWorker, enabling seamless email sending, configuration, and integration across multiple email providers.
...
- **ComWorker Integration**: Native integration with ComWorker's skill system
...
```json
{
  ...
  "sender_name": "ComWorker Assistant",
  "use_tls": true,
  "use_ssl": false
}
```
...
### ComWorker Integration

When installed as an ComWorker skill, you can use natural language commands:
...
├── comworker_integration.md    # ComWorker integration guide
...
- Built for [ComWorker](https://openclaw.ai) - The open-source AI assistant platform
...
- Check the [ComWorker documentation](https://docs.openclaw.ai)
- Join the [ComWorker community](https://discord.com/invite/clawd)
