...
### Using with ComWorker

If you're using ComWorker, you can place this skill in the skills directory:

```bash
# Assuming your ComWorker workspace is at ~/.comworker/workspace
cp -r playwright-scraper-skill ~/.comworker/workspace/skills/

# Then you can invoke it in ComWorker
```
