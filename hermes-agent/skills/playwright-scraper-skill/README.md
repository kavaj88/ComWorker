...
A Playwright-based web scraping ComWorker Skill with anti-bot protection. Successfully tested on complex websites like Discuss.com.hk.
...
1. **Try web_fetch first** — ComWorker's built-in tool is fastest
