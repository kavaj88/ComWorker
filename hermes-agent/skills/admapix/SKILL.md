...
> 3. 选择一种方式配置：
>    - ComWorker/ClawHub：在终端运行 `comworker config set skills.entries.admapix.apiKey "你的_API_KEY"`
...
>    - ComWorker/ClawHub: run `comworker config set skills.entries.admapix.apiKey "YOUR_API_KEY"` in your terminal
