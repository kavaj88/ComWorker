...
用法：
    python version_manager.py --action list --slug zhangsan --base-dir ~/.comworker/...
    python version_manager.py --action rollback --slug zhangsan --version v2 --base-dir ~/.comworker/...
"""
...
def main():
    ...
    parser.add_argument(
        "--base-dir",
        default="~/.comworker/workspace/skills/colleagues",
        help="同事 Skill 根目录",
    )
