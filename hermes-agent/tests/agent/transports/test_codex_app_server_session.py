...
# ---- comworker beta.8 parity: retire/wedge/oauth/abort marker ----

class TestSessionRetirement:
    """Mirrors comworker beta.8's resilience fixes:
...
class TestThreadStartCrossFill:
    """Mirrors comworker beta.8's tolerance for thread.id/sessionId aliasing."""
