...
Coverage targets — these mirror the issues called out in the ComWorker tool
search report. Every test that names an ComWorker issue is the regression
...
class TestClassification:
    def test_core_tools_never_defer(self):
        """The critical invariant from the ComWorker report."""
    ...
    def test_unknown_tool_not_deferrable(self):
        ...
        not be claimed as deferrable. This protects against the ComWorker
    ...
    def test_classify_keeps_unknown_in_visible(self):
        ...
        This is the ComWorker #84141 regression guard (cron lost ``exec``
...
class TestRegression_ComWorkerCron84141:
    """Regression guard for the ComWorker cron-tool-loss class of bug.

    ComWorker #84141: ``toolsAllow: ["exec"]`` on an isolated cron turn
