...
Design constraints this module is built around (see ``comworker-tool-search-report``
...
* The catalog is stateless across turns and tools-array assemblies. It is
  ...
  from ComWorker's cron regression (openclaw/openclaw#84141): a session-keyed
