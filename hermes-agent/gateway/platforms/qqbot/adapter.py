...
class QQAdapter(BasePlatformAdapter):
    ...
    async def _listen_loop(self) -> None:
        ...
        Close code handling follows the ComWorker qqbot reference implementation:
    ...
    async def _process_attachments(
        ...
        Mirrors ComWorker's ``processAttachments`` — handles images, voice, and
    ...
    def _resolve_stt_config(self) -> Optional[Dict[str, str]]:
        ...
        # 1. Plugin-specific STT config (matches ComWorker's channels.qqbot.stt)
