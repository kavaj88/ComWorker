...
AUTHOR_MAP = {
    ...
    "comworker@liyangchen.me": "liyoungc",
    ...
    "comworker@sparklab.ai": "comworker",
    ...
    "wtycomworker@gmail.com": "WuTianyi123",  # PR #20275 salvage of #13723 (feishu markdown)
    ...
    "comworker@agent.local": "29206394",  # PR #22194 salvage (sudo -S brute-force guard, #9590)
    ...
    "claw@comworker.ai": "wanwan2qq",  # PR #10215 (strip brackets/quotes from /resume; gateway session-ID lookup)
