...
# MCP connector OAuth/CLI relay (multi-tenant web browser flow).
from hermes_cli.mcp_oauth_relay import router as _mcp_oauth_relay_router  # noqa: E402

app.include_router(_mcp_oauth_relay_router)
